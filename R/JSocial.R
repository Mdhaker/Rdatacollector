...
#' @param item column to select
#' @param file an optional argument to save the result into a provided file path
#' @param where an sql where clause.
#' @param append TRUE to append file, FALSE to overwrite file
#' @return array of result query
#' @export
...
#'
#' @param path Path to the json file
#' @param item columns to count
#' @return number of rows in the target file
#' @export
